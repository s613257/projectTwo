								...
								<div class="section">
									...
									<form>
										...
										<div class="row">
											...
											<div class="form-floating mb-3 col-6">
												<div class="form-control" id="ArrivalTime" style="text-align: center;">
													2023/05/31
												</div>
										...
										<div class="row">
											...
											<div class="form-floating mb-3 col-6">
												<div class="form-control" id="priceTotal" style="text-align: center;">
													xx元
												</div>
										...
										<div style="text-align: center;">
											<button type="submit" class="btn btn-dark">確定訂票</button>
