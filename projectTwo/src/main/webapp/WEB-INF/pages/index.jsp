...
<head>
    ...
    <link href="/projectTwo/front/css/templatemo-leadership-event.css" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a href="index.html" class="navbar-brand mx-auto mx-lg-0">
                ...
                <span class="brand-text">TM</span>
            </a>

            <a class="nav-link custom-btn btn d-lg-none" href="#">Loggin</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <i class="fa-solid fa-location-dot"></i> 景點</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_4">
                            <i class="fa-solid fa-calendar-days"></i> 行程</a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <i class="fa-solid fa-face-smile-wink">
                            </i> 陪玩</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_9">
                            <i class="fa-solid fa-comments">
                            </i> 論壇</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" href="/projectTwo/front/ShoppingCart.jsp"><i class="fa-solid fa-cart-shopping"></i> 購物車</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_8"><i class="fa-solid fa-phone"></i> 聯繫</a>
                        </li>
					...
					<ul style="list-style: none;">
					  ...
					  <li class="nav-item"><a class="nav-link click-scroll" id="logOut">登出</a></li>
				       ...
				       <!--  <li class="nav-item">
				            <a class="nav-link custom-btn btn d-none d-lg-block" href="/ProjectTripMaster/TM.chih/login.jsp"><i class="fa-solid fa-arrow-right-to-bracket"></i> 登入</a>
				        </li> -->
    ...
    <main>
        ...
        <section class="hero" id="section_1">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-12 m-auto">
                        <div class="hero-text">
                            ...
                            <h1 class="text-white mb-4"><u class="text-info">Travel Master</u><br>2023</h1>
            ...
            <div class="video-wrap">
                <video autoplay="" loop="" muted="" class="custom-video" poster="">
                    <source src="/projectTwo/front/video/pagevideo.mp4" type="video/mp4">
        ...
        <section class="about section-padding" id="section_2">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12">
                            <h2 class="mb-4"><u class="text-info"></u></h2>
                        </div>

                        <div class="col-lg-6 col-12">
                            <h3 class="mb-3">放假想輕鬆安排行程?<br>2023首選TravelMaster!</h3>

                            <p>Travel
                                Master致力於為您帶來獨特而難忘的旅行經歷。我們的目標是將旅遊與冒險、文化與探索相結合，讓您在旅途中感受到無盡的驚喜與美好。立即開始您的旅行之旅！讓Travel
                                Master成為您探索世界的引導者，帶您穿越壯麗的風景、豐富多彩的文化和令人難忘的冒險。讓我們攜手開啟一個全新的旅行故事，為您創造終身難忘的回憶。
                            </p>

                            <a class="custom-btn btn custom-link mt-3" href="#section_4">查看熱門行程</a>
                            
                            <a class="custom-btn custom-border-btn btn custom-link mt-3 me-3" href="#section_3">搜尋熱門景點</a>

                        </div>

                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <h4>讓旅行成為你的故事，Travel Master為你譜寫不凡的章節。</h4>

                            <div class="avatar-group border-top py-5 mt-5">
                                <img src="https://stork.pet/wp-content/uploads/2023/03/111-14.jpg"
                                    class="img-fluid avatar-image" alt="">

                                <img src="https://www.pinview.com.tw/Upload/Article/19cab73e2508234fffd146924862aa47.jpg"
                                    class="img-fluid avatar-image avatar-image-left" alt="">

                                <img src="https://s.yimg.com/ny/api/res/1.2/cfLcI70Mr.nQsbd1hTUNFQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTY0MDtjZj13ZWJw/https://media.zenfs.com/en/petsmao_nownews_707/b19c759aa05907360f3ffd0c9b720d96"
                                    class="img-fluid avatar-image avatar-image-left" alt="">

                                <img src="https://p6-tt.byteimg.com/large/pgc-image/d0936501cfb343d08ad6b02f682f47db?from=pc"
                                    class="img-fluid avatar-image avatar-image-left" alt="">

                                <p class="d-inline">120+ 人說TravelMaster很讚!</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="contact section-padding" id="section_3" style="background-image: url(/ProjectTripMaster/TM.sean/images/beach.jpg);">
...
<!--                             <h2 class="mb-5 text-center">下一趟 <a href="/ProjectTripMaster/ProductPage"><u class="text-info">行程</u></a></h2>
 -->							
 								 <h2 class="mb-5 text-center">下一趟 <a href="/ProjectTripMaster/ProductPage"><u class="text-info">行程</u></a></h2>
                            <nav>
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-DayOne" role="tabpanel"
                                    ...
                                    <div class="row border-bottom pb-5 mb-5">
                                        <div class="col-lg-4 col-12">
                                            <img src="img/schedule/fabian-friedrich-JDUVM9_VaZE-unsplash.jpg"
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <p>You are free to download any HTML CSS template from TemplateMo website.
                                                ...
                                                redistribute the downloadable ZIP file on any other template website.
                                                Thank
                                                you.</p>

                                            <div class="d-flex align-items-center mt-4">
                                                <div class="avatar-group d-flex">
                                                    <img src="img/avatar/happy-asian-man-standing-with-arms-crossed-grey-wall.jpg"
                                                        class="img-fluid avatar-image" alt="">
                                    ...
                                    <div class="row border-bottom pb-5 mb-5">
                                        <div class="col-lg-4 col-12">
                                            <img src="img/schedule/clayton-cardinalli-JMoFpdqL3XM-unsplash.jpg"
                                                class="schedule-image img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <p>Quisque mollis, ante non semper ultricies, nulla sapien sollicitudin
                                                augue,
                                                id scelerisque nunc turpis nec urna. Class aptent taciti sociosqu ad
                                                litora.
                                            </p>

                                            <div class="d-flex align-items-center mt-4">
                                                <div class="avatar-group d-flex">
                                                    <img src="img/avatar/portrait-good-looking-brunette-young-asian-woman.jpg"
                                                        class="img-fluid avatar-image" alt="">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-12">
                                            <img src="img/schedule/business-woman-making-presentation-office.jpg"
                                                class="schedule-image img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per
                                                inceptos himenaeos. Ut consequat purus posuere tortor efficitur, sit
                                                amet
                                                dignissim libero aliquam.</p>

                                            <div class="d-flex align-items-center mt-4">
                                                <div class="avatar-group d-flex">
                                                    <img src="img/avatar/senior-man-white-sweater-eyeglasses.jpg"
                                                        class="img-fluid avatar-image" alt="">
                                ...
                                <div class="tab-pane fade" id="nav-DayTwo" role="tabpanel"
                                    ...
                                    <div class="row border-bottom pb-5 mb-5">
                                        <div class="col-lg-4 col-12">
                                            <img src="img/schedule/people-smiling-while-conference-room.jpg"
                                                class="schedule-image img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div class="d-flex align-items-center mt-4">
                                                <div class="avatar-group d-flex">
                                                    <img src="img/avatar/pretty-smiling-joyfully-female-with-fair-hair-dressed-casually-looking-with-satisfaction.jpg"
                                                        class="img-fluid avatar-image" alt="">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-12">
                                            <img src="img/schedule/jason-goodman-bzqU01v-G54-unsplash.jpg"
                                                class="schedule-image img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div class="d-flex align-items-center mt-4">
                                                <div class="avatar-group d-flex">
                                                    <img src="img/avatar/indoor-shot-beautiful-happy-african-american-woman-smiling-cheerfully-keeping-her-arms-folded-relaxing-indoors-after-morning-lectures-university.jpg"
                                                        class="img-fluid avatar-image" alt="">
                                ...
                                <div class="tab-pane fade" id="nav-DayFour" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-12">
                                            <img src="img/schedule/jeshoots-com-TWRCH-GaKr4-unsplash.jpg"
                                                class="schedule-image img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <p>There is a plenty of great HTML CSS templates available at TemplateMo.com
                                                website for your businesses. You can download, edit and use any template
                                                for
                                                any purpose. Please let us know <a rel="nofollow"
                                                    href="https://templatemo.com/contact" target="_parent"><u>your
                                                        feedback
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-5 mb-lg-0">
                            <div class="pricing-thumb bg-white shadow-lg">
                                ...
                                <div class="pricing-body">
                                    ...
                                    <a class="custom-btn btn mt-3" href="#">Login</a>
                                </div>
                            </div>
                        </div>
            ...
            <section class="contact section-padding" id="section_7" style="background-image: url();">

            </section>

            <section class="contact section-padding" id="section_8" style="background-image: url(/ProjectTripMaster/TM.sean/images/beach.jpg);">
                <div class="container">
                    <div class="row">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-12 ms-lg-auto">
                        <div class="copyright-text-wrap d-flex align-items-center">
                            <p class="copyright-text ms-lg-auto me-4 mb-0">Copyright © 2023 TravelMaster.
